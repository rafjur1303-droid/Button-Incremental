...
let meStatsInfoVis = false;
//=====(RESEARCHERS)=====
let researchers = 0;
let researchersMoneyCost = 1000000000000;
let researchersMultiplierCost = 1000000000;
...
//=====(POWIADOMIENIE PO ODBLOKOWANIU CZEGOŚ NOWEGO)=====
let upgradeUnlocked = false;
let superRebirthUnlocked = false;
let megaUnlocked = false;
let up3Unlocked = false;
let up4Unlocked = false;
let up5Unlocked = false;
let up6Unlocked = false;
let up7Unlocked = false;
let up8Unlocked = false;
let up9Unlocked = false;
let researchUnlocked = false;
let re2Unlocked = false;
let re3Unlocked = false;
let re4Unlocked = false;
let re6Unlocked = false;
let re7Unlocked = false;
let re8Unlocked = false;
let re9Unlocked = false;
let re10Unlocked = false;
let re11Unlocked = false;
let re12Unlocked = false;
